    ...
    return Scaffold(
      ...
      drawer: Drawer(
        ...
        child: Column(
          ...
          ].divide(SizedBox(height: 20.0)).addToStart(SizedBox(height: 50.0)),
        ),
      ),
      appBar: AppBar(
            ...
            Padding(
              ...
              child: FutureBuilder<ApiCallResponse>(
                ...
                builder: (context, snapshot) {
                  ...
                  return Builder(
                    builder: (context) {
                      final articles = (listViewArticlesResponse.jsonBody
                                  .toList()
                                  .map<ArticlesStruct?>(
                                      ArticlesStruct.maybeFromMap)
                                  .toList() as Iterable<ArticlesStruct?>)
                              .withoutNulls
                              ?.toList() ??
                          [];
