                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          StreamBuilder<List<CommandRecord>>(
                            stream: queryCommandRecord(
                              queryBuilder: (commandRecord) =>
                                  commandRecord.where(
                                'user_id',
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<CommandRecord> listViewCommandRecordList =
                                  snapshot.data!;
                              ...
                              return ListView.separated(
                                ...
                                itemCount: listViewCommandRecordList.length,
                                separatorBuilder: (_, __) =>
                                    SizedBox(height: 12.0),
                                itemBuilder: (context, listViewIndex) {
                                  final listViewCommandRecord =
                                      listViewCommandRecordList[listViewIndex];
                                  return Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        16.0, 0.0, 16.0, 0.0),
                                    child: Container(
